...
public class LoginController implements Initializable {
    ...
    private void HandleEvents(javafx.scene.input.MouseEvent event) {
        ...
        if (txtNickname.getText().isEmpty() || txtUsername.getText().isEmpty() || txtPassword.getText().isEmpty()) {
            ...
            warnLabel.setStyle("-fx-text-fill: white;-fx-background-color: red;-fx-padding: 10 10 10 10;");
            warnLabel.setText("fill the blanks");
        } else {
            String s=createUser(txtUsername.getText(), txtNickname.getText(), txtPassword.getText());

            if(s.equals("user created successfully!")) {
                warnLabel.setVisible(true);
                warnLabel.setStyle("-fx-text-fill: white;-fx-background-color: green;-fx-padding: 10 10 10 10;");
                warnLabel.setText(s);
            }
            else {
                warnLabel.setVisible(true);
    ...
    public String loginUser(String username, String password) {
        ...
        try (FileReader reader = new FileReader("D:\\project\\project\\src\\main\\resources\\view\\players.json"))
        {
