...
public class TrapCard extends Card{
    ...
    public TrapCard(String name, int number, String type, String cardDescription, boolean side, long price, String icon,String status, String imgPat) throws IOException {
        super(name, number, type, cardDescription, side, price,imgPat);
        this.icon=icon;
        this.status=status;
