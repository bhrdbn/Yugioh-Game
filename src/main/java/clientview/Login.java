...
public class Login  {
    ...
    public void run() {
        ...
        while (true) {
            ...
            else if (matcher1_7.find())
                loginUser(matcher1_7, 0);
    ...
    public void createUser(Matcher matcher, int flag) {
        if (flag == 0) {
            System.out.println(controller.createUser(matcher.group(1), matcher.group(2), matcher.group(3)));
            b = 6;
        } else if (flag == 1) {
            System.out.println(controller.createUser(matcher.group(2), matcher.group(1), matcher.group(3)));
        } else if (flag == 2) {
            System.out.println(controller.createUser(matcher.group(1), matcher.group(3), matcher.group(2)));
        } else if (flag == 3) {
            System.out.println(controller.createUser(matcher.group(3), matcher.group(1), matcher.group(2)));
        } else if (flag == 4) {
            System.out.println(controller.createUser(matcher.group(2), matcher.group(3), matcher.group(1)));
        } else if (flag == 5) {
            System.out.println(controller.createUser(matcher.group(3), matcher.group(2), matcher.group(1)));
        }
    }
