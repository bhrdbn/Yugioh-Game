...
//    private static clientview.DeckView deckView=null;
//    private DeckView(){
//
//    }
//    public static clientview.DeckView getInstance()
//    {
//        if (deckView == null)
//            deckView = new clientview.DeckView();
//
//        return deckView;
//    }
//
...
//            Matcher matcher4_1=getCommand(input, "^deck add-card card ([a-zA-Z\\s]+) deck (\\w+) side$");
//            Matcher matcher4_2=getCommand(input, "^deck add-card side deck (\\w+) card ([a-zA-Z\\s]+)$");
//            Matcher matcher4_3=getCommand(input, "^deck add-card side card ([a-zA-Z\\s]+) deck (\\w+)$");
//            Matcher matcher5=getCommand(input,"^deck rm-card card ([a-zA-Z\\s]+) deck (\\w+)$");
//            Matcher matcher5_1=getCommand(input,"^deck rm-card deck (\\w+) card ([a-zA-Z\\s]+)$");
//            Matcher matcher6=getCommand(input,"^deck rm-card deck (\\w+) card ([a-zA-Z\\s]+) side$");
//            Matcher matcher6_1=getCommand(input,"^deck rm-card card ([a-zA-Z\\s]+) deck (\\w+) side$");
//            Matcher matcher6_2=getCommand(input,"^deck rm-card side deck (\\w+) card ([a-zA-Z\\s]+)$");
//            Matcher matcher6_3=getCommand(input,"^deck rm-card side card ([a-zA-Z\\s]+) deck (\\w+)$");
...
//        System.out.println(controller.createDeck(matcher.group(1)));
//    }
//    public void deleteDeck(Matcher matcher) {
//        System.out.println(controller.deleteDeck(matcher.group(1)));
//    }
//    public void activateDeck(Matcher matcher){
//        System.out.println(controller.activateDeck(matcher.group(1)));
//    }
//    public void addCardToDeck(Matcher matcher,int flag){
//        if(flag==0)
//            System.out.println(controller.addCardToDeck(matcher.group(2), matcher.group(1), 1));
//        else if(flag==1)
//            System.out.println(controller.addCardToDeck(matcher.group(1), matcher.group(2), 1));
//        else if(flag==2||flag==4)
//            System.out.println(controller.addCardToDeck(matcher.group(1), matcher.group(2), 0));
//        else if(flag==3||flag==5)
//            System.out.println(controller.addCardToDeck(matcher.group(2), matcher.group(1), 0));
//    }
//    public void removeCardFromDeck(Matcher matcher,int flag){
//        if(flag==0)
//            System.out.println(controller.removeCardFromDeck(matcher.group(2), matcher.group(1), 1));
//        else if(flag==1)
//            System.out.println(controller.removeCardFromDeck(matcher.group(1), matcher.group(2), 1));
//        else if(flag==2||flag==4)
//            System.out.println(controller.removeCardFromDeck(matcher.group(1), matcher.group(2), 0));
//        else if(flag==3||flag==5)
//            System.out.println(controller.removeCardFromDeck(matcher.group(2), matcher.group(1), 0));
//    }
//    public void showAllDecks(){
//        System.out.println(controller.showDecks());
//    }
//    public void showADeck(int flag , Matcher matcher){
//        if(flag==1) {
//            System.out.println(controller.showADeck(matcher.group(1), 1));
//        }
//        else {
//            System.out.println(controller.showADeck(matcher.group(1),0));
//        }
//
//    }
//    public void showAllCards(){
//        System.out.println(controller.showAllCards());
//    }
//
