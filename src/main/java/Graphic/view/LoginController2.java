...
public class LoginController2 {
    ...
    private static LoginController2 loginController = null;

    private LoginController2() {
    ...
    public static LoginController2 getInstance() {
        if (loginController == null)
            loginController = new LoginController2();
